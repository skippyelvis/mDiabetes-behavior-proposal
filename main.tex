...
\subsection{Training}
At each time step observed, $t$, retrieve the students oberservation feature vector \\ 
$\{M1_t,Q1_t,M2_t,Q2_t\}$ and outcome vector $\{Q1\_response_t,Q2\_response_t\}$. Using our model $M$ with weights $w$, we can calculate the predicted response probabilities for this student interaction $P_t$. 
